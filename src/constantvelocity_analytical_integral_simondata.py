...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--model_beta', '-MB', default=7.15, type=float)
    arg_parser.add_argument('--learning_rate', '-LR', default=0.025, type=float)
    arg_parser.add_argument('--num_epochs', '-NE', default=75, type=int)
    ...
    arg_parser.add_argument('--data_set_test', '-DATA', default=10, type=int)
